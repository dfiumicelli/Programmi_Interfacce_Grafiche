...
public class SwingApplication7 extends JFrame {
    ...
    public SwingApplication7() {
        super("SwingApplication7");
    ...
    //utilizziamo un oggetto action listener per evitare di creare delle classi interne. Metodo ottimale
    private ActionListener eventHandlerBut1(){
        ActionListener listbut1=new ActionListener() {
            @Override
                public void actionPerformed(ActionEvent e){
                numClicks++;
                jlabel.setText(labelPrefix + numClicks);
    ...
    private ActionListener eventHandlerBut2(){
        ActionListener listbut2=new ActionListener() {
            public void actionPerformed(ActionEvent e){
                slowMethod(1);
                numSlowClicks++;
                jlab2.setText(lab2Prefix + numSlowClicks);
    ...
    public static void main(String[] args) throws Exception {
        ...
        javax.swing.SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                new SwingApplication7().setVisible(true);
            }
        });
