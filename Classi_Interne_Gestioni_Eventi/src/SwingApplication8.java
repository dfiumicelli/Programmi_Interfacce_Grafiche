...
public class SwingApplication8 extends JFrame {
    ...
    public SwingApplication8() {
        super("SwingApplication8");
        ...
        }); //abbiamo messo tutto dentro l'argomento della funzione per evitare di usare nuovi metodi, ma è na palla perché allunga il costruttore.
    ...
    public static void main(String[] args) throws Exception {
        ...
        javax.swing.SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                new SwingApplication8().setVisible(true);
            }
        });
