...
public class SwingApplication5 extends JFrame {
    ...
    public static void main(String[] args) throws Exception {
        ...
        javax.swing.SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                new SwingApplication5().setVisible(true);
            }
        });
